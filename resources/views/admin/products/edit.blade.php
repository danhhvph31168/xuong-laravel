                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <select type="text" class="form-select" name="catelogue_id" id="catelogue_id">
                                            @foreach ($catelogues as $id => $name)
                                                <option @selected($id == $product->catelogue_id) value="{{ $id }}">
                                                    {{ $name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mt-3">
                                        ...
                                        @if ($product->img_thumbnail)
                                            ...
                                            @else
                                                <img src="{{ $product->img_thumbnail }}" width="100px">
                                            @endif
                                        @endif
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-check form-switch form-switch-{{ $color }}">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        name="{{ $key }}" value="{{ $product->$key }}"
                                                        id="{{ $key }}"
                                                        @if ($product->$key == 0) checked @endif>
                                                ...
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        @if ($variants[$key]['image'])
                                                            @if (!\Str::contains($variants[$key]['image'], 'http'))
                                                                <img src="{{ \Storage::url($variants[$key]['image']) }}"
                                                                    width="50px" height="50px">
                                                            @else
                                                                <img src="{{ $variants[$key]['image'] }}" width="50px"
                                                                    height="50px">
                                                            @endif
                                                        @endif
                                                    </td>
                                            ...
                                            <div class="d-flex">
                                                ...
                                                @if (!\Str::contains($variants[$key]['image'], 'http'))
                                                    <img src="{{ \Storage::url($item->image) }}" width="50px"
                                                        height="39px">
                                                @else
                                                    <img src="{{ $item->image }}" width="50px" height="39px">
                                                @endif
